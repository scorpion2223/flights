...
class AddressCountryChoose extends StatefulWidget{
  final double height ;
  final bool status;
  final VoidCallback onPressed;
  final String name;

  const AddressCountryChoose({
    super.key,
  ...
  State<StatefulWidget> createState() {
    return _AddressCountryChoose();
  }

}

class _AddressCountryChoose extends State<AddressCountryChoose>{
  @override
