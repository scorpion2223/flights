...
//
//     final bookingNewParam = bookingNewParamFromJson(jsonString);

import 'dart:convert';

BookingNewParam bookingNewParamFromJson(String str) => BookingNewParam.fromJson(json.decode(str));

String bookingNewParamToJson(BookingNewParam data) => json.encode(data.toJson());

class BookingNewParam {
  Data? data;
  ...
  factory BookingNewParam.fromJson(Map<String, dynamic> json) => BookingNewParam(
...
class Data {
  ...
  Data copyWith({
    ...
    List<ContactElement>? contacts,
      ...
      Data(
        type: type ?? this.type,
        originLocationCode: originLocationCode ?? this.originLocationCode,
        destinationLocationCode: destinationLocationCode ?? this.destinationLocationCode,
