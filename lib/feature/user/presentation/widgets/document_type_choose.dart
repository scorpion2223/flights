...
class DocumentTypeChoose extends StatefulWidget{
  final double height ;
  final bool status;
  final VoidCallback onPressed;
  final String name;

  const DocumentTypeChoose({
    super.key,
  ...
  State<StatefulWidget> createState() {
    return _DocumentTypeChoose();
  }

}

class _DocumentTypeChoose extends State<DocumentTypeChoose>{
  @override
